...
#ifndef BOOST_ASIO_BASIC_HOMA_SOCKET_HPP
#define BOOST_ASIO_BASIC_HOMA_SOCKET_HPP
...
class basic_homa_socket;

#endif // !defined(BOOST_ASIO_BASIC_HOMA_SOCKET_FWD_DECL)

/// Provides homa-oriented socket functionality.
/**
 * The basic_homa_socket class template provides asynchronous and blocking
 * homa-oriented socket functionality.
 *
 * @par Thread Safety
...
public:
  ...
  struct rebind_executor
  {
    ...
    typedef basic_homa_socket<Protocol, Executor1> other;
  };
  ...
  /// Construct a basic_homa_socket without opening it.
  /**
   * This constructor creates a homa socket without opening it. The open()
   * function must be called before data can be sent or received on the socket.
   *
   * @param ex The I/O executor that the socket will use, by default, to
   * dispatch handlers for any asynchronous operations performed on the socket.
   */
  explicit basic_homa_socket(const executor_type& ex)
  ...
  explicit basic_homa_socket(ExecutionContext& context,
      constraint_t<
  ...
  /// Construct and open a basic_homa_socket.
  /**
   * This constructor creates and opens a homa socket.
   *
   * @param ex The I/O executor that the socket will use, by default, to
   * dispatch handlers for any asynchronous operations performed on the socket.
   *
   ...
   */
  basic_homa_socket(const executor_type& ex, const protocol_type& protocol)
   ...
   */
  template <typename ExecutionContext>
  basic_homa_socket(ExecutionContext& context,
  ...
  /// Construct a basic_homa_socket, opening it and binding it to the given
  /// local endpoint.
  /**
   * This constructor creates a homa socket and automatically opens it bound
   ...
   * dispatch handlers for any asynchronous operations performed on the socket.
   *
   * @param endpoint An endpoint on the local machine to which the homa
   * socket will be bound.
   *
   * @throws boost::system::system_error Thrown on failure.
   */
  basic_homa_socket(const executor_type& ex, const endpoint_type& endpoint)
  ...
  /// Construct a basic_homa_socket on an existing native socket.
  /**
   * This constructor creates a homa socket object to hold an existing
   * native socket.
   *
   * @param ex The I/O executor that the socket will use, by default, to
   * dispatch handlers for any asynchronous operations performed on the socket.
   ...
   * @throws boost::system::system_error Thrown on failure.
   */
  basic_homa_socket(const executor_type& ex,
  ...
  /// Move-construct a basic_homa_socket from another.
  /**
   * This constructor moves a homa socket from one object to another.
   *
   * @param other The other basic_homa_socket object from which the move
   * will occur.
   *
   * @note Following the move, the moved-from object is in the same state as if
   * constructed using the @c basic_homa_socket(const executor_type&)
   * constructor.
   */
  basic_homa_socket(basic_homa_socket&& other) noexcept
    : basic_socket<Protocol, Executor>(std::move(other))
  {
  }

  /// Move-assign a basic_homa_socket from another.
  /**
   * This assignment operator moves a homa socket from one object to
   * another.
   *
   * @param other The other basic_homa_socket object from which the move
   * will occur.
   ...
   * constructor.
   */
  basic_homa_socket& operator=(basic_homa_socket&& other)
  {
    basic_socket<Protocol, Executor>::operator=(std::move(other));
    return *this;
  }

  /// Move-construct a basic_homa_socket from a socket of another protocol
  /// type.
  /**
   * This constructor moves a homa socket from one object to another.
   *
  ...
  basic_homa_socket(basic_homa_socket<Protocol1, Executor1>&& other,
      constraint_t<
  ...
  /// Move-assign a basic_homa_socket from a socket of another protocol
  /// type.
  /**
   * This assignment operator moves a homa socket from one object to
   * another.
  ...
  constraint_t<
    is_convertible<Protocol1, Protocol>::value
      && is_convertible<Executor1, Executor>::value,
    basic_homa_socket&
  > operator=(basic_homa_socket<Protocol1, Executor1>&& other)
  {
    basic_socket<Protocol, Executor>::operator=(std::move(other));
    return *this;
  }
   ...
   * the send_to function to send data on an unconnected homa socket.
   *
   * @par Example
  ...
  // {
  //   boost::system::error_code ec;
  //   std::size_t s = this->impl_.get_service().homa_send(
  //                                                       this->impl_.get_implementation(), buffers, flags, id, completion_cookie, ec);
  //   boost::asio::detail::throw_error(ec, "send");
  //   return s;
  // }
  ...
  /**
   * This function is used to asynchronously send data on the homa socket.
   ...
   * Use the async_send_to function to send data on an unconnected homa
   * socket.
   *
   * @par Example
   * To send a single data buffer use the @ref buffer function as follows:
                      ...
                      , uint64_t *id, uint64_t completion_cookie)
  {
    ...
    std::size_t s = this->impl_.get_service().homa_send_to(
                                                      this->impl_.get_implementation(), buffers, destination, flags, id, completion_cookie, ec);
  ...
  std::size_t send_to(const ConstBufferSequence& buffers,
      ...
      boost::system::error_code& ec)
  {
    return this->impl_.get_service().homa_send_to(this->impl_.get_implementation(),
                                             buffers, destination, flags, id, completion_cookie, ec);
  }

  /// Start an asynchronous send.
  /**
   * This function is used to asynchronously send a homa to the specified
  ...
  /**
   * This function is used to receive data on the homa socket. The function
  ...
  /**
   * This function is used to asynchronously receive data from the homa
...
#endif // BOOST_ASIO_BASIC_HOMA_SOCKET_HPP
